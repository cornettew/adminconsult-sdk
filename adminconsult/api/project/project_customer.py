...
class ProjectCustomer(Entity):
    ...
    def __init__(self, client_credentials: ClientCredentials, project_id: int, payload=None):
        ...
        self.co_contractor = None
        self.customer_id = None
        self.direct_debit = None
        self.invoice_annex_id = None
        self.invoice_percentage = None
        self.invoicing_address_id = None
        self.is_taskflow_customer = None
        self.need_invoice_annex = None
        self.project_customer_id = None
        self.project_id = project_id
        self.vat_excl_text_id = None
        self.vat_incl = None
